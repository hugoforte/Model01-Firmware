...
#define BUILD_INFORMATION "locally built by Hugo Forte 4/29/2022"
#endif
...
enum { PRIMARY, NUMPAD, FUNCTION, SELECTS }; // layers
...
KEYMAPS(
  ...
  (Key_Escape,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   LCTRL(LALT(Key_Delete)),  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, ShiftToLayer(SELECTS),
   Key_RightShift),
  ...
  (___,      ___,           ___,      ___,     ___,        ___,           Key_CapsLock,
   ...
   Consumer_PlaySlashPause,    Key_LeftCurlyBracket, Key_RightCurlyBracket,     Key_UpArrow,    , Key_LeftBracket, Key_RightBracket,
                               ___,                    Key_LeftArrow,            Key_DownArrow,  Key_RightArrow,  ___,              ___,
   Key_PcApplication,          Consumer_Mute,          Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
   Key_Pipe, ___, Key_LeftBracket, Key_RightBracket,
   ___),
